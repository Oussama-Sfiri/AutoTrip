package com.ParcAuto.Ensa.Affectation.AspectsAOP.Logging.Vehicules;
...
@Aspect
@Component
public class LoggingVehiculeAspect {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    @Around("execution(* com.ParcAuto.Ensa.Affectation.Services.VehiculeService.*(..))")
    public Object logVehiculeServiceMethods(ProceedingJoinPoint joinPoint) throws Throwable {
