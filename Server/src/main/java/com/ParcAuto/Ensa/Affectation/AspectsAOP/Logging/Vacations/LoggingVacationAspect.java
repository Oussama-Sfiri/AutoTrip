package com.ParcAuto.Ensa.Affectation.AspectsAOP.Logging.Vacations;
...
@Aspect
@Component
public class LoggingVacationAspect {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    @Around("execution(* com.ParcAuto.Ensa.Affectation.Services.VacationService.*(..))")
    public Object logVacationServiceMethods(ProceedingJoinPoint joinPoint) throws Throwable {
