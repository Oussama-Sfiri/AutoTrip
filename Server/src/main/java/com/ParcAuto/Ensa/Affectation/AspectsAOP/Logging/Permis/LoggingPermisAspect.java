package com.ParcAuto.Ensa.Affectation.AspectsAOP.Logging.Permis;
...
@Aspect
@Component
public class LoggingPermisAspect {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    @Around("execution(* com.ParcAuto.Ensa.Affectation.Services.PermisService.*(..))")
    public Object logPermisServiceMethods(ProceedingJoinPoint joinPoint) throws Throwable {
