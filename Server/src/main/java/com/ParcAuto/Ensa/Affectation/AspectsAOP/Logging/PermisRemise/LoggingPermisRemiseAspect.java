package com.ParcAuto.Ensa.Affectation.AspectsAOP.Logging.PermisRemise;
...
@Aspect
@Component
public class LoggingPermisRemiseAspect {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    @Around("execution(* com.ParcAuto.Ensa.Affectation.Services.PermisRemiseService.*(..))")
    public Object logPermisRemiseServiceMethods(ProceedingJoinPoint joinPoint) throws Throwable {
