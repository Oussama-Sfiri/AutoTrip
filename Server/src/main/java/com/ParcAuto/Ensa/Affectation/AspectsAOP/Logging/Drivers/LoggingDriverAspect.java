package com.ParcAuto.Ensa.Affectation.AspectsAOP.Logging.Drivers;
...
@Aspect
@Component
public class LoggingDriverAspect {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    @Around("execution(* com.ParcAuto.Ensa.Affectation.Services.DriverService.*(..))")
    public Object logDriverServiceMethods(ProceedingJoinPoint joinPoint) throws Throwable {
